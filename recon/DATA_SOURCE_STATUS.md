...
- [`benchmark/src/network.mjs`](../benchmark/src/network.mjs)
- [`benchmark/src/diagnose-network.mjs`](../benchmark/src/diagnose-network.mjs)
- [`benchmark/src/ws-collector.mjs`](../benchmark/src/ws-collector.mjs)

原始诊断报告位于本地忽略目录：

- `benchmark/data/diagnostics/network-20260818.json`
- `benchmark/data/diagnostics/dns-20260818.json`
